...
public class dto_productos {
    ...
    public dto_productos(int id_producto, String nom_producto, String des_producto, double stock, double precio, String unidad_medida, int estado_producto, int categoria, String fecha_entrada) {
